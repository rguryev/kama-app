...
const variants = cva(
  "shadow-grid rounded-3xl sm:bg-background bg-neutral-50 dark:bg-neutral-900 flex flex-col justify-center @container",
  {
    variants: {
      size: {
        "1x2": "md:col-span-1 col-span-3 row-span-2 md:p-8 p-4",
    ...
    <div
      className={cn(
        variants({
          size,
          className:
            "transition-colors duration-75 ease-in-out hover:bg-neutral-50 hover:shadow-xl dark:border-white/[0.2] dark:bg-black hover:dark:bg-neutral-950",
        }),
      )}
    >
      {children}
